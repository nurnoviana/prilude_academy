...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-image: linear-gradient(to right, #a5e1fdec , #ffffff);">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand text-info" href="<?php echo base_url('home_pengajar/index')?>" style="font-family: 'Righteous', cursive; font-size: x-large;">Prilude
                        Academy</a>
                </div>
                ...
                <div class="navbar-nav mr-auto">
                    <a class="nav-item nav-link" href="<?php echo base_url('home_pengajar/index')?>">Home </span></a>
                    <a class="nav-item nav-link" href="<?php echo base_url('mentor/kehadiran/index')?>">Kehadiran</a>
                    <a class="nav-item nav-link" href="<?php echo base_url('mentor/agenda/index')?>">Agenda Pertemuan</a>
                </div>
                <ul class="nav navbar-nav navbar-right row">
                    ...
                    Hello, <?php echo $this->session->nama_lengkap; ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="<?php echo base_url('home_pengajar/show_profile') ?>"><i class="fa fa-user-circle"></i> My Profile</a>
    ...
    <footer class="container-fluid text-center fixed-bottom" style="background-color: #535455;">
